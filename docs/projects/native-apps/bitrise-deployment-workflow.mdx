...
:::note Prerequisites
Before you can complete the bitrise setup, you will need to manually upload the first APK file to the Google Play Store using [this guide](/projects/native-apps/upload-android-first-build). 
:::
